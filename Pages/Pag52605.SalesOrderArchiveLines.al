page 52605 "ORB Sales Order Archive Lines"
{
    Caption = 'Sales Order Archive Lines';
    ApplicationArea = All;
    Editable = false;
    LinksAllowed = false;
    PageType = List;
    ...
    begin
        ...
        DocumentLineTracking.SetSourceDoc(Enum::"Document Line Source Type"::"Sales Order", Rec."Document No.", Rec."Line No.", Rec."Blanket Order No.", Rec."Blanket Order Line No.", '', 0);
