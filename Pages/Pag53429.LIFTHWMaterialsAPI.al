page 53429 "ORB LIFT HW Materials API"
{
    ...
    PageType = API;
    SourceTable = Item;
    SourceTableView = where(Blocked = const(false), "Department Dimension" = const('01'), "ORB Material Id" = filter(<> 0), "ORB Stroage Type Id" = filter(<> 0), "ORB Has Active Variants" = const(false), "ORB Do Not Integrate" = const(false));
