report 53412 "ORB LIFT Mod. Prices By Item"
{
    ApplicationArea = All;
    Caption = 'LIFT Modified Prices By Item';
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            begin
                ...
                ModifiedSalesPricesQuery.SetFilter(ItemNo, Item."No.");
    ...
    var
        ...
        FilterMustNotBeEmpty: Label 'There must be atleast one filter';
