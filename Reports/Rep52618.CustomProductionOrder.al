report 52618 "ORB Custom Production Order"
{
    // version TCM7.1.1904
    // ************************
    // Copyright Notice
    ...
    begin
        if "Prod. Order Line"."Line No." > 10000 then
            Orbus_Subcomponent1 := '(Subcomponent)'
        else
            Orbus_Subcomponent1 := ''
    end;
            ...
            repeat
                if ProdOrderRoutingLine."Routing Link Code" <> '' then begin
                    ...
                    if ProdOrderComponent.FindFirst() then
                        if Orbus_RoutingLinkItemNo1 = '' then begin
    ...
    begin
        ...
        if ProdOrderComponent.FindSet() then
            repeat
                ItemNo := ItemNo + CRLF + CRLF + ProdOrderComponent."Item No.";
                // CompDescription := CompDescription + CRLF + CRLF + ProdOrderComponent."Short Description";
                CompDescription := CompDescription + CRLF + CRLF + ProdOrderComponent.Description;
    ...
    begin
        ...
        if ProdOrderRoutingLine.FindFirst() then
            if ProdOrderRoutingLine."Routing Link Code" <> '' then begin
                ...
                if ProdOrderComponent.FindSet() then
                    repeat
                        ComponentItemNoWC := ComponentItemNoWC + CRLF + CRLF + ProdOrderComponent."Item No.";
                        //ComponentDescriptionWC := ComponentDescriptionWC + CRLF + CRLF + ProdOrderComponent."Short Description";
                        ComponentDescriptionWC := ComponentDescriptionWC + CRLF + CRLF + ProdOrderComponent.Description;
