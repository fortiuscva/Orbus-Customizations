report 52600 "ORB Check (Stub/Check/Stub)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/Layouts/ORBCheckStubCheckStub.rdl';
    Caption = 'ORB Check (Stub/Check/Stub)';
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    column(AppliesToDocNo; AppliesToDocNo)
                    {
                    }
                    column(DocNo; DocNo)
                    {
                    ...
                    begin
                                            ...
                                            if GenJnlLine2."Applies-to Doc. No." = '' then begin
                                                ...
                                                case BalancingType of
                                                    BalancingType::"G/L Account":
                                                        begin
                                                            AppliesToDocNo := GenJnlLine2."Applies-to Doc. No.";
                        ...
                        Stub2AppliesToDocNo[Stub2LineNo] := AppliesToDocNo;
                    ...
                    begin
                        ...
                        if PreprintedStub then begin
                            ...
                            TotalText := Text019;
                            Stub2AppliesToDocNoHeader := RefNo_CaptionLbl;
                ...
                dataitem(PrintCheck; "Integer")
                {
                    ...
                    column(Stub2AppliesToDocNoHeader; Stub2AppliesToDocNoHeader)
                    {
                    }
                    ...
                    column(Stub2AppliesToDocNo_1_; Stub2AppliesToDocNo[1])
                    {
                    }
                    ...
                    column(Stub2AppliesToDocNo_2_; Stub2AppliesToDocNo[2])
                    {
                    }
                    ...
                    column(Stub2AppliesToDocNo_3_; Stub2AppliesToDocNo[3])
                    {
                    }
                    ...
                    column(Stub2AppliesToDocNo_4_; Stub2AppliesToDocNo[4])
                    {
                    }
                    ...
                    column(Stub2AppliesToDocNo_5_; Stub2AppliesToDocNo[5])
                    {
                    }
                    ...
                    column(Stub2AppliesToDocNo_6_; Stub2AppliesToDocNo[6])
                    {
                    }
                    ...
                    column(Stub2AppliesToDocNo_7_; Stub2AppliesToDocNo[7])
                    {
                    }
                    ...
                    column(Stub2AppliesToDocNo_8_; Stub2AppliesToDocNo[8])
                    {
                    }
                    ...
                    column(Stub2AppliesToDocNo_9_; Stub2AppliesToDocNo[9])
                    {
                    }
                    ...
                    column(Stub2AppliesToDocNo_10_; Stub2AppliesToDocNo[10])
                    {
                    }
    ...
    var
        ...
        Stub2LineNo: Integer;
        Stub2AppliesToDocNo: array[50] of Text[35];
        ...
        Stub2AppliesToDocNoHeader: Text[30];
        ...
        RefNo_CaptionLbl: Label 'Ref. No.';
        USText011: Label 'Your Invoice No.';
        USText012: Label 'Invoice Date';
        USText013: Label 'Invoice Amount';
    ...
    begin
        ...
        AppliesToDocNo := CopyStr(CustLedgEntry2."Document No.", 6, MaxStrLen(CustLedgEntry2."Document No."));
        DocNo := CustLedgEntry2."Document No.";
        ExtDocNo := CustLedgEntry2."External Document No.";
        DocNo := CustLedgEntry2."External Document No.";
    ...
    begin
        ...
        AppliesToDocNo := CopyStr(VendLedgEntry2."Document No.", 6, MaxStrLen(VendLedgEntry2."Document No."));
