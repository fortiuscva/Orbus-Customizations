report 53402 "ORB Registered Inventory Pick"
{
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Registered Warehouse Pick';
    RDLCLayout = './Reports/Layouts/OrbusRegPickAdvncdWhse.rdl';
    ...
    dataset
    {
        dataitem("Registered Whse. Activity Hdr."; "Registered Whse. Activity Hdr.")
        {
            ...
            column(CustomerSupportCode; CustomerSupportVarGbl)
            {
            }
            ...
            begin
                ...
                if SalesHeader.FindFirst() then begin
                    ...
                    CustomerSupportVarGbl := SalesHeader."ORB Customer Support";
                    If (SalesHeader."In-Hands Date" <> 0D) then
                        RequestedDeliveryDate := Format(SalesHeader."In-Hands Date", 0, '<Month>/<Day>/<Year4>')
                    else
