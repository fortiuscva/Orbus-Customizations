codeunit 53400 "ORB LIFT Sales Order Mgmt"
{
    ...
    local procedure UpdateSalesHeader(var LIFTSalesOrderBuffer: Record "ORB LIFT Sales Order Buffer"; InsertMode: Boolean)
    begin
        ValidateSalesHeaderFields(SalesHeader, LIFTSalesOrderBuffer, InsertMode);
        SalesHeader.Modify();
    end;
    ...
    begin
        ...
        UpdateSalesLine(LIFTSalesLineBuffer, true);
    end;
    ...
    begin
        ...
        SalesLine.SetRange("ORB LIFT Line ID", LIFTSalesLineBuffer."LIFT Line ID");
        if SalesLine.FindLast() then
            UpdateSalesLine(LIFTSalesLineBuffer, false);
    end;

    local procedure UpdateSalesLine(var LIFTSalesLineBuffer: Record "ORB LIFT Sales Line Buffer"; InsertMode: Boolean)
    begin
        ValidateSalesLineFields(SalesLine, LIFTSalesLineBuffer, InsertMode);
        SalesLine.Modify();
    ...
    begin
        ...
        if not InsertMode then begin
            ...
            IF LIFTSalesLineBuffer.Type = LIFTSalesLineBuffer.Type::Comment then begin
                ...
                //SalesLine.Validate("Line Discount Amount", (BCLineDiscount + SalesLine."ORB LIFT Discount Amount"));
                SalesLine.Validate("Line Discount Amount", (BCOriginalDiscount + SalesLine."ORB LIFT Discount Amount"));
                SalesLine.Validate("ORB LIFT Unit Price", LIFTSalesLineBuffer."Unit Price"); // To Capture the Discounted Unit Price on to the Sales Line during Insert Mode.
                SalesLine."ORB LIFT Line ID" := LIFTSalesLineBuffer."LIFT Line ID";
